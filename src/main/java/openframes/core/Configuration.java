...
import openframes.carriage.CarriagePackageBlacklist;
...
public class Configuration extends Config {
    ...
    public void Process() {
        {
            BlockIds.Carriage = BlockId("Carriages", 1126);

            BlockIds.CarriageDrive = BlockId("Carriage Drives", 1127);

            BlockIds.Spectre = BlockId("Motive Spectre", 1128);
        }

        {
            ToolItemSet.Id = ItemId("Tools", 11237);

            SimpleItemSet.Id = ItemId("Simple Items", 11238);
        }
